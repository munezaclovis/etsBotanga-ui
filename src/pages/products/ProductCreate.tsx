...
const ProductCreate = () => {
    ...
    const onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setProduct({
            ...product,
            data: { ...product?.data, [e.target.name]: e.target.value },
        });
    };
    return (
        <>
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                className={`form-control${
                                    product?.errors?.fields?.name !== undefined
                                        ? " border-danger"
                                        : ""
                                }`}
                                name="name"
                            ...
                            />
                            <InputErrors
                                errors={product?.errors?.fields?.name}
                            />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                type="text"
                                className={`form-control${
                                    product?.errors?.fields?.image_link !==
                                    undefined
                                        ? " border-danger"
                                        : ""
                                }`}
                            ...
                            />
                            <InputErrors
                                errors={product?.errors?.fields?.image_link}
                            />
                        </div>
                        ...
                        <div className="mb-3">
                            <div className="row">
                                <div className="col">
                                    ...
                                    <InputErrors
                                        errors={
                                            product?.errors?.fields?.discount
                                        }
                                    />
                                </div>
                                <div className="col">
                                    ...
                                    <InputErrors
                                        errors={product?.errors?.fields?.price}
                                    />
                                </div>
                                <div className="col">
                                    <label
                                    ...
                                    <InputErrors
                                        errors={
                                            product?.errors?.fields?.quantity
                                        }
                                    />
                                </div>
                            </div>
